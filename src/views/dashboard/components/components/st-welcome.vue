<template>
    <div class="flex justify-between">
            ...
            "
                ...
                <div class="pl-3 mt-2">
                    ...
                    <div class="leading-5 mt-2">
                        <a-tag color="blue" bordered>快乐工作快乐生活</a-tag>
                        djafsiodshfoiuadhsuifadsiufiudsahuiadshiu
                        <a-space size="large">
                            <a-link @click="donate">
                                <icon-thumb-up/>
                                dasfadsf
        ...
        <a-modal :footer="false" v-model:visible="visible">
            <template #title>dfhjskghifadsfhidsiufhadhsiufds</template>
            <a-image src="https://www.google.com"/>
        </a-modal>
    </div>
</template>
